...
fn test_complete_4_5() {
    ...
    let sol1 = Command::new("pace2024verifier")
        .args(["-c","tiny_test_set/complete_4_5.gr","tiny_test_set/complete_4_5.sol"])
        .output()
        .unwrap();
    
    let sol2 = Command::new("pace2024verifier")
        .args(["-c","tiny_test_set/complete_4_5.gr","tiny_test_set_official_solutions/complete_4_5.sol"])
        .output()
        .unwrap();
...
fn test_cycle_8_shuffled() {
    ...
    let sol1 = Command::new("pace2024verifier")
        .args(["-c","tiny_test_set/cycle_8_shuffled.gr","tiny_test_set/cycle_8_shuffled.sol"])
        .output()
        .unwrap();
    
    let sol2 = Command::new("pace2024verifier")
        .args(["-c","tiny_test_set/cycle_8_shuffled.gr","tiny_test_set_official_solutions/cycle_8_shuffled.sol"])
        .output()
        .unwrap();
...
fn test_cycle_8_sorted() {
    test_file("tiny_test_set/cycle_8_sorted.gr",
...
fn test_grid_9_shuffled() {
    test_file("tiny_test_set/grid_9_shuffled.gr",
...
fn test_ladder_4_4_shuffled() {
    test_file("tiny_test_set/ladder_4_4_shuffled.gr",
...
fn test_ladder_4_4_sorted() {
    test_file("tiny_test_set/ladder_4_4_sorted.gr",
...
fn test_matching_4_4() {
    test_file("tiny_test_set/matching_4_4.gr",
...
fn test_path_9_shuffled() {
    test_file("tiny_test_set/path_9_shuffled.gr",
...
#[test]
fn test_plane_5_6() {
    test_file("tiny_test_set/plane_5_6.gr",
...
#[test]
fn test_star_6() {
    test_file("tiny_test_set/star_6.gr",
...
#[test]
fn test_tree_6_10() {
    test_file("tiny_test_set/tree_6_10.gr",
...
#[test]
fn test_website_20() {
    test_file("tiny_test_set/website_20.gr",
